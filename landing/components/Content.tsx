...
export function Content() {
  return (
    <section className="max-w-5xl mx-auto text-center mt-40">
      ...
      <h2 className="text-2xl inline-flex items-center text-slate-300">
        powered by
        <svg
      ...
      <p className="my-20 leading-loose px-20 text-slate-400 text-lg">
      ...
      {/* <div className="grid grid-cols-5 gap-4 mb-20">
        <div className="flex flex-col text-left rounded-md p-3 bg-slate-700 border border-slate-500">
      ...
      <div className="relative">
        ...
        <div className="flex items-center justify-between px-3 py-2 bg-slate-700 rounded-t-md">
